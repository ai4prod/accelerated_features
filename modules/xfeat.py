...
class XFeat(nn.Module):
	...
	def extractDense(self, x, top_k = 8_000):
		"""
		Fa il preprocessing del tensore ed esegue 
		il forward della rete
		"""
		if top_k < 1:
			top_k = 100_000_000
		print("TOPK ",top_k)
		...
		#espande la meshgrid per ogni batch
		...
		#estrae i punti e le features in base ai top_k
	...
	def extract_dualscale(self, x, top_k, s1 = 0.6, s2 = 1.3):
		#scala immagine originale. Una più piccola e una più grande
		...
		B, _, _, _ = x.shape
		#assegna meno punti all'imamgine più piccola
